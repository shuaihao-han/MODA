...
class DOTADataset(CustomDataset):
    ...
    CLASSES = ('car', 'van', 'truck', 'bus', 'tricycle', 'bike', 'awning-bike','pedestrian')   # Drmod
    # CLASSES = ('car', 'truck', 'tractor', 'camping', 'van', 'others', 'pickup','boat', 'plane')   # vedai

    # PALETTE = [(165, 42, 42), (189, 183, 107), (0, 255, 0), (255, 0, 0),
    #            (138, 43, 226), (255, 128, 0), (255, 0, 255), (0, 255, 255),
    #            (255, 193, 193), (0, 51, 153), (255, 250, 205), (0, 139, 139),
    #            (255, 255, 0), (147, 116, 116), (0, 0, 255)]
    PALETTE = [(0, 255, 0), (255, 0, 0), (255, 0, 255), (0, 255, 255),
               (255, 193, 193), (255, 250, 205), (255, 255, 0), (0, 0, 255)]   # Drmod
    # PALETTE = [(0, 255, 0), (255, 0, 0), (255, 0, 255), (0, 255, 255),
    #         (255, 193, 193), (255, 250, 205), (255, 255, 0), (0, 0, 255), (147, 116, 116)]
    ...
    def load_annotations(self, ann_folder):
        ...
        if not ann_files:  # test phase
            ...
            for ann_file in ann_files:
                data_info = {}
                img_id = osp.split(ann_file)[1][:-4]
                img_name = img_id + self.seg_suffix    # [origin]：img_name = img_id + '.png'
                data_info['filename'] = img_name
                data_info['ann'] = {}
                gt_bboxes = []
                gt_labels = []
