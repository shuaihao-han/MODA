...
model = dict(
    ...
    backbone=dict(
        ...
        num_stages=4,
        out_indices=(0, 1, 2, 3),
        # frozen_stages=1,    # [origin]: frozen_stages=1,
        zero_init_residual=False,
        norm_cfg=dict(type='BN', requires_grad=True),
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='work_dirs/rotated_retinanet/resnet50_retinanet_fine_tunned_epoch14_train.pth')),   # [origin]: checkpoint='torchvision://resnet50'
    neck=dict(
        type='FPN',
...
optimizer = dict(lr=0.008)     # [origin]: lr=0.008
