_base_ = [
    '../_base_/datasets/dotav1_vedai_data_aug.py', '../_base_/schedules/schedule_1x.py',
...
train_pipeline = [
    ...
    dict(type='Mosaic', img_scale=(640, 640)), 
        #  dict(type='RandomAffine', scaling_ratio_range=(0.5, 1.5)),   # [added]
...
optimizer = dict(lr=0.002)   # [origin]: lr=0.008
