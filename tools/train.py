...
def parse_args():
    ...
    parser.add_argument('--work-dir', default="work_dir/oriented_reppoint/debug", help='the dir to save logs and models')
    parser.add_argument(
...
def main():
    ...
    model.init_weights()   # 对网络参数进行初始化
    # 将除了backbone之外的网络参数进行冻结
